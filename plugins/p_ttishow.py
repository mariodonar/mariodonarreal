...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            buttons = [[
                InlineKeyboardButton('📌 ᴄᴏɴᴛᴀᴄᴛ ꜱᴜᴘᴘᴏʀᴛ 📌', url=f'https://t.me/chat_sup_6')
            ]]
            ...
            return
        buttons = [[
                    InlineKeyboardButton("🍁 ʜᴏᴡ ᴛᴏ ᴜꜱᴇ 🍁", url="https://t.me/AIO_Movies_Bot?start=help")
                  ]]
        reply_markup=InlineKeyboardMarkup(buttons)
...
async def leave_a_chat(bot, message):
    ...
    try:
        buttons = [[
                  InlineKeyboardButton("📌 ᴄᴏɴᴛᴀᴄᴛ ꜱᴜᴘᴘᴏʀᴛ 📌", url="https://t.me/chat_sup_6")
                  ]]
        reply_markup=InlineKeyboardMarkup(buttons)
...
async def get_ststs(bot, message):
    if query.from_user.id in ADMINS:
        ...
        await query.answer("Sᴏʀʀʏ Tʜɪs Cᴏᴍᴍᴀɴᴅ Oɴʟʏ Fᴏʀ Mʏ Aᴅᴍɪɴs 👀", show_alert=True)
