...
BOT_TOKEN = environ.get('BOT_TOKEN', "7716114735:AAFzW06LYUuwFRLg4dB6n7SPoV-zMNJW5ew")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://envs.sh/s/CSRrz-88k7xMigz38iqJ8A/5RX.jpg')).split() #SAMPLE PIC
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002413283517 -1002322134400').split()] #Channel id for auto indexing ( make sure bot is admin )
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '').split()]
auth_channel = environ.get('AUTH_CHANNEL', '-1002345510042') #Channel / Group Id for force sub ( make sure bot is admin )
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'mariodonar')
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+jH3NZ3VTs5JhN2I1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/All_In_One_Linkz')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002423270359')) #Log channel id ( make sure bot is admin )
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/chat_sup_6') #Support group link ( make sure bot is admin )
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002413880375'))
